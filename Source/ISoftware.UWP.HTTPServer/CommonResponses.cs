...
namespace ISoftware.UWPl.HTTPServer
{
    ...
    {
        public static HTTPResponse FoundRedirect(string location)
        {
            Dictionary<string, string> headers = new Dictionary<string, string> { ["location"] = location };
            HTTPResponse response = new HTTPResponse(HttpStatusCode.Found, headers, null);
